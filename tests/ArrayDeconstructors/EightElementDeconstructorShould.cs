...
{
    public class EightElementDeconstructorShould : ArrayDeconstructionTest
    {
        public EightElementDeconstructorShould() 
            : base(elementCount: 8)
        {
        }
        ...
        {
            var (first, second, third, fourth, fifth, sixth, seventh, eighth) = array;
